...
/**
 * This file is for the login route, this route displays a form where a user can enter their existing details and submit it
 * to log in to the application and access the menu.
 */
